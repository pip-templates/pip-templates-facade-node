...
export class FacadeFactory extends Factory {
	public static FacadeServiceV1Descriptor = new Descriptor("pip-facade-sample", "service", "http", "*", "1.0");
	public static FacadeServiceV2Descriptor = new Descriptor("pip-facade-sample", "service", "http", "*", "2.0");
